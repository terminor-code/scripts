...
* Risk levels are respected — Critical > High > Medium > Low > Info.
...
try:
    ...
    final_merged = final_merged[['Name', 'Risk', 'Host', 'Description', 'Synopsis', 'Solution']]

    # === Step 9: Save final Excel with wrapping ===
